...
SET(CMAKE_ASM_COMPILER ${toolchain}/bin/i686-elf-gcc)
SET(CMAKE_C_COMPILER ${toolchain}/bin/i686-elf-gcc)
SET(CMAKE_CXX_COMPILER ${toolchain}/bin/i686-elf-g++)
...
SET(CMAKE_C_FLAGS "-O2 -g -nostdlib -ffreestanding -fbuiltin -Wall -Wextra -std=gnu99 -msse" CACHE STRING "" FORCE)